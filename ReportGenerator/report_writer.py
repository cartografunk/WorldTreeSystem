...
from ReportGenerator.utils.dynamic_text_blocks import fetch_dynamic_values, format_paragraphs
from ReportGenerator.utils.docx_helpers import render_title, render_intro_and_table
from ReportGenerator.graficadorG1Mortalidad import generar_mortalidad
from ReportGenerator.graficadorG2Altura import generar_altura
from ReportGenerator.graficadorG3Crecimiento import generar_crecimiento
from ReportGenerator.graficadorG4DefectosyPlagas import generar_tabla_sanidad
import argparse
from ReportGenerator.utils.helpers import get_region_language
from ReportGenerator.utils.text_templates import text_templates
from ReportGenerator.utils.text_calculations import get_mortality_metrics
from docx.oxml import OxmlElement
from docx.oxml.ns import qn
from docx.shared import Inches
from ReportGenerator.utils.config import EXPORT_WIDTH_INCHES, EXPORT_HEIGHT_INCHES

# Configuración de rutas
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
TEMPLATE = os.path.join(BASE_DIR, "ReportGenerator", "templates", "Template.docx")
OUTPUT_DIR = os.path.join(BASE_DIR, "ReportGenerator", "outputs", "reports")
IMG_TMP_DIR = os.path.join(BASE_DIR, "ReportGenerator", "temp_images")
...
def crear_reporte(code: str, country: str, year: int, engine) -> str:
    ...
    output_root = os.path.join(BASE_DIR, "ReportGenerator", "outputs")
    paths = {
